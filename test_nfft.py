...
class TestNfft(unittest.TestCase):
    ...
    def test_nfft_2d(self):
        a = numpy.random.random((self._size, )*2)
        ft_nfft = nfft.nfft(a, 1., [[self._coord_1d[self._2d_coord[0][0]], self._coord_1d[self._2d_coord[0][1]]],
                                    [self._coord_1d[self._2d_coord[1][0]], self._coord_1d[self._2d_coord[1][1]]]])
        ft_fftw = numpy.fft.fftshift(numpy.fft.fft2(numpy.fft.fftshift(a)))
        numpy.testing.assert_almost_equal(ft_nfft, ft_fftw[(self._2d_coord[0][0], self._2d_coord[1][0]), (self._2d_coord[0][1], self._2d_coord[1][1])])
    ...
    def test_nfft_inplace_2d(self):
        ...
        nfft.nfft_inplace(a, 1., [[self._coord_1d[self._2d_coord[0][0]], self._coord_1d[self._2d_coord[0][1]]],
    ...
    def test_nfft_3d(self):
        ...
        ft_nfft = numpy.empty(2, dtype="complex128")
        nfft.nfft_inplace(a, 1., [[self._coord_1d[self._3d_coord[0][0]], self._coord_1d[self._3d_coord[0][1]], self._coord_1d[self._3d_coord[0][2]]],
    ...
    def test_nfft_4d(self):
        ...
        ft_nfft = numpy.empty(2, dtype="complex128")
        nfft.nfft_inplace(a, 1., [[coord_1d[self._4d_coord[0][0]],
                                   coord_1d[self._4d_coord[0][1]],
                                   coord_1d[self._4d_coord[0][2]],
                                   coord_1d[self._4d_coord[0][3]]],
                                  [coord_1d[self._4d_coord[1][0]],
                                   coord_1d[self._4d_coord[1][1]],
                                   coord_1d[self._4d_coord[1][2]],
                                   coord_1d[self._4d_coord[1][3]]]],
                          ft_nfft)
        ft_fftw = numpy.fft.fftshift(numpy.fft.fftn(numpy.fft.fftshift(a)))
...
if __name__ == "__main__":
    ...
    suite = unittest.TestLoader().loadTestsFromTestCase(TestNfft)
